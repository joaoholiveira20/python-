...
# Função para adicionar um novo clientes na lista.
...
def encontrar_cliente_por_nome(lista_clientes, nome_buscar):
    email_buscar_lower = nome_buscar.lower() 
...
def atualizar_clientes(lista_clientes):
    ...
    print("--- Atualizar dados do ciente ---")
    email_buscar = input("\nDigite o E-mail do cliente: ")    
    cliente_para_atualizar = encontrar_cliente_por_nome(lista_clientes, email_buscar)
...
def excluir_cliente(lista_cliente):
    ...
    cliente_para_remover = encontrar_cliente_por_nome(lista_clientes, email_buscar)
